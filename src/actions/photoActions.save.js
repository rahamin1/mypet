...
const uploadImageAsync = async(userId, curTime, photoUri) => {
  ...
  console.log("In photoActions/uploadImageAsync. await fetch completed. response: ");
  ...
  console.log("In photoActions/uploadImageAsync. await response.blob completed. blob:");
  console.log(blob);
  ...
  const ref = firebase
    ...
    console.log("In photoActions/uploadImageAsync. put(blob) starting.");
    await ref.put(blob).then(async(snapshot) => {
      console.log("In photoActions/uploadImageAsync. put(blob) completed.");
    ...
    console.log("In photoActions/uploadImageAsync. ref.getDownloadURL completed.");
