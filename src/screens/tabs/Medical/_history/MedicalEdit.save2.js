...
import { medicalUpdate, medicalAdd } from 'mypet/actions';
...
class MedicalEdit extends React.Component {
  ...
  onClearForm(e) {
    ...
    if (this.state.newItem) // ading a new item
      this.props.medicalAdd(this.props.auth.email, formPayload, this.props.navigation);
    else // editing an existing item
      this.props.medicalUpdate(this.props.auth.email, formPayload, this.props.navigation);
	}
